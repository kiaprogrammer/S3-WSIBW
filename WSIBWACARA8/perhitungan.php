...
echo "Jumlah: " . $kalkulator->getHasil() ."\n"; // Output: Jumlah: 15

$kalkulator->kurang(10, 5);
echo "Selisih: " . $kalkulator->getHasil() ."\n"; // Output: Selisih: 5

$kalkulator->kali(10, 5);
echo "Hasil Kali: " . $kalkulator->getHasil() ."\n"; // Output: Hasil Kali: 50

$kalkulator->bagi(10, 2);
echo "Hasil Bagi: " . $kalkulator->getHasil() ."\n"; // Output: Hasil Bagi: 5
